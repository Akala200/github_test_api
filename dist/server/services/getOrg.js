      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios2.default.get('https://api.github.com/users/' + username + '/orgs', { headers: { Authorization: 'Bearer ' + _index2.default.githubtoken } });

          case 3:
            org = _context.sent;
            return _context.abrupt('return', org.data);
